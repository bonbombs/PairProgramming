...
public class RomanArabicConverter {
  ...
  public RomanArabicConverter (String value) throws MalformedNumberException, ValueOutOfBoundsException {
  	...
  	if(value.isEmpty()) throw new MalformedNumberException("Must input value");
  ...
  public String toRoman() throws ValueOutOfBoundsException {
  	...
  	if(current < 1) throw new ValueOutOfBoundsException("Invalid Input: Value cannot be negative");
